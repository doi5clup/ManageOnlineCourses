...
function initModels(sequelize) {
    ...
    giaovien.belongsToMany(khoahoc, {
        as: 'MaKH_khoahocs',
        through: giaovienphanhoi,
        foreignKey: 'MaGV',
        otherKey: 'MaKH',
    });
    hocvien.belongsToMany(khoahoc, {
        as: 'MaKH_khoahoc_hocvien_tg_khoahocs',
        through: hocvien_tg_khoahoc,
        foreignKey: 'MaHV',
        otherKey: 'MaKH',
    });
    hocvien.belongsToMany(khoahoc, {
        as: 'MaKH_khoahoc_hocvienphanhois',
        through: hocvienphanhoi,
        foreignKey: 'MaHV',
        otherKey: 'MaKH',
    });
    khoahoc.belongsToMany(giaovien, {
        as: 'MaGV_giaoviens',
        through: giaovienphanhoi,
        foreignKey: 'MaKH',
        otherKey: 'MaGV',
    });
    khoahoc.belongsToMany(hocvien, {
        as: 'MaHV_hocviens',
        through: hocvien_tg_khoahoc,
        foreignKey: 'MaKH',
        otherKey: 'MaHV',
    ...
    khoahoc.belongsToMany(hocvien, {
        as: 'MaHV_hocvien_hocvienphanhois',
        through: hocvienphanhoi,
        foreignKey: 'MaKH',
        otherKey: 'MaHV',
    });
    giaovienphanhoi.belongsTo(giaovien, {
        as: 'MaGV_giaovien',
        foreignKey: 'MaGV',
    });
    giaovien.hasMany(giaovienphanhoi, {
        as: 'giaovienphanhois',
        foreignKey: 'MaGV',
    });
    khoahoc.belongsTo(giaovien, { as: 'GVCN_giaovien', foreignKey: 'GVCN' });
    giaovien.hasMany(khoahoc, { as: 'khoahocs', foreignKey: 'GVCN' });
    hocvien_tg_khoahoc.belongsTo(hocvien, {
        as: 'MaHV_hocvien',
        foreignKey: 'MaHV',
    });
    hocvien.hasMany(hocvien_tg_khoahoc, {
        as: 'hocvien_tg_khoahocs',
        foreignKey: 'MaHV',
    });
    hocvienphanhoi.belongsTo(hocvien, {
        as: 'MaHV_hocvien',
        foreignKey: 'MaHV',
    });
    hocvien.hasMany(hocvienphanhoi, {
        as: 'hocvienphanhois',
        foreignKey: 'MaHV',
    });
    giaovienphanhoi.belongsTo(khoahoc, {
        as: 'MaKH_khoahoc',
        foreignKey: 'MaKH',
    });
    khoahoc.hasMany(giaovienphanhoi, {
        as: 'giaovienphanhois',
        foreignKey: 'MaKH',
    });
    hocvien_tg_khoahoc.belongsTo(khoahoc, {
        as: 'MaKH_khoahoc',
        foreignKey: 'MaKH',
    });
    khoahoc.hasMany(hocvien_tg_khoahoc, {
        as: 'hocvien_tg_khoahocs',
        foreignKey: 'MaKH',
    });
    hocvienphanhoi.belongsTo(khoahoc, {
        as: 'MaKH_khoahoc',
        foreignKey: 'MaKH',
    });
    khoahoc.hasMany(hocvienphanhoi, {
        as: 'hocvienphanhois',
        foreignKey: 'MaKH',
    });
    giaovien.belongsTo(log_in, {
        as: 'ID_LogIn_log_in',
        foreignKey: 'ID_LogIn',
    });
    log_in.hasMany(giaovien, { as: 'giaoviens', foreignKey: 'ID_LogIn' });
    hocvien.belongsTo(log_in, {
        as: 'ID_LogIn_log_in',
        foreignKey: 'ID_LogIn',
    });
